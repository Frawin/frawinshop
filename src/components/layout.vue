<template>
  <div>
      ...
      <div class="app-head-inner">
        ...
        <div class="head-nav">
          ...
          <li  class="nav-pile" v-if="username !== ''">|</li>
            <li v-if="username !== ''" @click="exit">退出</li>
    ...
    <my-dialog :is-show="isShowLogDialog" @on-close ="closeMyLogDialog">
    	<log-form @has-log = "onSuccessLog" ></log-form>
    </my-dialog>
    <my-dialog :is-show="isShowRegDialog" @on-close ="closeMyRegDialog">
...
export default {
  ...
  methods:{
  	...
  	onSuccessLog(data){
  		...
  		this.closeMyLogDialog()
  	},
  	onSuccessReg(data){
  		this.username = data,
  		this.closeMyRegDialog(),
  		alert("注册成功，将自动为您登陆")
  	},
  	exit(){
  		this.username = ""
